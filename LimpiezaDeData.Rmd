...
### 1. Uso de [expresiones regulares](https://www.youtube.com/watch?v=sa-TUpSx1JA)
...
```{r, eval=FALSE}
# me trae cada numero
str_extract_all(string = urban[1,2],pattern="\\d")
```

```{r, eval=FALSE}
# me trae numeros adyacentes:
str_extract_all(urban[1,2],
...
Otra función importante es **trimws()**, que  elimina espacios en blanco antes y despues de texto (nota el [regex](https://www.regular-expressions.info/shorthand.html) que incluí:
