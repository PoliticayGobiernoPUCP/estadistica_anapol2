...
* Usamos mejor toda la información disponible. Es una tecnica multivariada, y tomará en cuenta diversos tipos de datos que no podrían ser _promediables_.

* La operación de promediar se reemplaza por la de encontrar "distancias" entre los casos. La distancia multivariada es la que determina que casos debe agruparse juntos, cómo separarse, y qué casos considerarse singulares. El video siguiente trata de explicar ello:

<iframe width="800" height="600" src="https://www.youtube.com/watch?v=3MnVCX94jJM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

* Tenemos muchos algoritmos. Para diversas situaciones, tenemos diferentes algoritmos recomendables para encontrar una mejor clusterización. Los algoritmos vistos en este curso corresponden a tres famlias:
  - Particionantes.
  - Jerarquizantes.
  - Basados en densidad.
  ...
  <iframe width="800" height="600" src="https://www.youtube.com/watch?v=Se28XHI2_xE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
