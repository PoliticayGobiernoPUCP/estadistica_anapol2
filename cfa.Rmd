...
```{r}
medidas=c("tli","rmsea","rmsea.ci.lower","rmsea.ci.upper","rmsea.pvalue")
fitmeasures(fit,fit.measures = medidas)
```
...
```{r}
HappyDemo=cbind(HappyDemo,lavPredict(fit))
```
