...
En esta sesión deseo que entiendas por qué es necesario ir más allá de la correlación (_Pearson_, _Spearman_, etc.) o las diferencias de valores medios (_t test_, _kruska wallis_, etc.). Esta necesidad de ir más allá tiene una técnica de apoyo conocida como la regresión. 
